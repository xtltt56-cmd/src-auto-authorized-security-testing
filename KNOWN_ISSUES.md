...
> **当前发布读取规则：** 当前基线为 `v0.10.0`，有效状态以本节、[RELEASE_MANIFEST.md](RELEASE_MANIFEST.md) 与 [TEST_REPORT.md](TEST_REPORT.md) 顶部验收为准。下方标为“历史记录”的旧版本状态仅用于追溯，不覆盖当前版本。

## 2026-09-16 v0.10.0 当前状态
