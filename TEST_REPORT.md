...
> **当前发布验收基线：** 本报告顶部的“可视化本地靶场控制升级验收（2026-08-28）”适用于 `v0.8.28-loopback-lab-control`。下方所有早于 2026-08-28 的段落均为历史追溯，不覆盖本发布的功能、测试数量或运行结论。旧 ZAP 会话、扫描缓存和机器工件已从 Git 发布内容中排除；当前发布范围见 [RELEASE_MANIFEST.md](RELEASE_MANIFEST.md)。
